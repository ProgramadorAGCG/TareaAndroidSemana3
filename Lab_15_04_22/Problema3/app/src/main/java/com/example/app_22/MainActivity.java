    ...
    public void onClick(View view) {
        if(view == btnaceptar){
            ...
            switch(rdgLinea.getCheckedRadioButtonId()){
                case
                        R.id.rbtLan:recargo=precio*0.10;linea="LAN";break;
                case
                        R.id.rbtAvianca:recargo=precio*0.12;linea="AVIANCA";break;
                case
                        R.id.rbtChosicano:recargo=0;linea="CHOSICANO FLY";break;
            }
